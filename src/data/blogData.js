export const blogPosts = [
  {
    ...
    content: `
        ...
        <p>Living in a noisy area? Roller shutters significantly reduce external noise, giving you a quieter and more peaceful living or working space.</p>
  
        <h3>4. Weather Protection</h3>
        <p>Harsh weather conditions like strong winds, rain, and excessive sunlight can damage your property. Roller shutters provide an extra layer of protection against these elements.</p>
        ...
        <ul>
          ...
          <li><strong>Commercial Roller Shutters:</strong> Designed for businesses, these shutters provide extra security for shopfronts, warehouses, and offices.</li>
          <li><strong>Fire-Rated Roller Shutters:</strong> Provide additional safety by slowing down the spread of fire, giving you crucial time to act in an emergency.</li>
        ...
        <ul>
          ...
          <li><strong>Professional Installation:</strong> Our expert team ensures that your <a href="https://kdshopfrontandshutters.com/shutters-perforated/" target="_blank">shutters doors</a>  are installed correctly for maximum efficiency and longevity.</li>
        ...
        <ol>
          <li><strong>Consultation:</strong> We discuss your needs and recommend the best shutter options.</li>
          <li><strong>Measurement:</strong> Our experts take precise measurements to ensure a perfect fit.</li>
          <li><strong>Manufacturing:</strong> Your custom shutters are manufactured with top-grade materials.</li>
          <li><strong>Installation:</strong> Our skilled technicians install the shutters efficiently.</li>
          <li><strong>Testing & Maintenance Advice:</strong> We ensure proper functionality and provide maintenance tips.</li>
        </ol>
  
        <h2>Maintenance Tips for Roller Shutters</h2>
        <ul>
          <li><strong>Regular Cleaning:</strong> Remove dust and debris to keep the shutters functioning smoothly.</li>
          <li><strong>Lubrication:</strong> Apply lubrication to moving parts to prevent rust and ensure smooth operation.</li>
          <li><strong>Check for Damage:</strong> Inspect for any wear and tear and get timely repairs if needed.</li>
...
<img src="/blog/doorshop.jpg" alt="Types of Roller Shutters" style="width:100%; height:450px; margin-bottom: 20px;" />
    ...
    <ul>
      ...
      <li>✅ <strong>Glass finishes:</strong> Clear, tinted, frosted, or laminated glass for added security and privacy.</li>
      <li>✅ <strong>Automation features:</strong> Sensor adjustments, access control systems, and remote operation.</li>
      <li>✅ <strong>Color variations:</strong> Powder-coated finishes to match your brand identity.</li>
    </ul>
    ...
    <ul>
      <li>✔ Checking and calibrating motion sensors.</li>
      <li>✔ Lubricating moving parts for smooth operation.</li>
      <li>✔ Inspecting electrical components for any faults.</li>
    ...
    <ul>
      ...
      <li>💰 <strong>Competitive pricing:</strong> Without compromising on features.</li>
      <li>🚀 <strong>Quick turnaround:</strong> For installations and repairs.</li>
      <li>🛠 <strong>Expert consultation:</strong> To help you choose the best door solution.</li>
      <li>😊 <strong>Customer satisfaction guarantee:</strong> With after-sales support.</li>
    </ul>
